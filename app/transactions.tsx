                ...
                <PanGestureHandler onGestureEvent={gestureHandler}>
                    <Animated.View style={[styles.tabWrapper, animatedStyle]}>
                        ...
                        >
                            ...
                            <View style={styles.categories}>
                                <TransactionCategory title="Shopping" date="15 Mar 2025, 15:00 PM" price="-120$" category="shopping" variant={2} />
                                <TransactionCategory title="travel" date="15 Mar 2025, 15:00 PM" price="-120$" category="travel" variant={2} />
                                <TransactionCategory title="medicine" date="15 Mar 2025, 15:00 PM" price="-120$" category="medicine" variant={2} />
                                <TransactionCategory title="sport" date="15 Mar 2025, 15:00 PM" price="-120$" category="sport" variant={2} />
                                <TransactionCategory title="Shopping" date="15 Mar 2025, 15:00 PM" price="-120$" category="shopping" variant={2} />
                                <TransactionCategory title="travel" date="15 Mar 2025, 15:00 PM" price="-120$" category="travel" variant={2} />
                            </View>
                        </LinearGradient>
